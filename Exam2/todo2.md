...
## T03 Antithetic Variates 的比较口径需进一步说明
...
- 加一句说明当前比较采用 lecture 中的 pair estimator 口径。
- 更严谨的方案是额外比较普通 MC 的 `2N` 条独立路径，以区分 pair negative correlation 和路径数量增加的影响。

## T04 “二元期权在深度虚值时方差极高”表述不准确
